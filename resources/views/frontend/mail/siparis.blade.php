        ...
        <td align="center" valign="top">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" valign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
                            <tr>
                                <td align="center" valign="top" style="background:#FFF;"><table width="260" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top">
                                                            <a href="https://www.sasder.com">
                                                                <img mc:edit="tm-01" editable="true" src="https://sasder.org/frontend/img/sasderlogo.png" width="300" alt="" />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="center" valign="top"><table width="85" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td height="85" align="center" valign="middle" style="background:#00509d; -moz-border-radius: 85px; border-radius: 85px;">
                                                            <img mc:edit="tm-02" editable="true" src="https://www.godijital.net/images/tick.png" width="31" height="29" alt="" /></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:22px; color:#4b4b4c; line-height:30px; font-weight:normal;"
                                                mc:edit="tm-03" ><multiline>Merhaba <br />
                                                    Syn. {{ $User->name.' '. $User->user->surname }}</multiline></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#71746f;
                                            line-height:22px; font-weight:normal;" mc:edit="tm-05" ><multiline>Kaydınız başaralı bir şekilde tarafımıza ulaşmıştır.  <br />
                                                    Kaydınız değerlendirildikten sonra email ile sizlere dönüş yapılacaktır.</multiline></td>
                                        </tr>
                                        <tr>
                    ...
                    <td align="center" valign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
                            <tr>
                                <td align="center" valign="top"><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:normal;"
                                                mc:edit="tm-11" ><multiline>SAĞLIK VE SİGORTA YÖNETİCİLERİ DERNEĞİ (SASDER)</multiline></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#4b4b4c;
                                            line-height:20px; font-weight:bold;" mc:edit="tm-12">
                                                <multiline>Merkez Efendi Mah. Mevlana Cad. Aktaş Blok <br />
                                                    No:108 D:58 Zeytinburnu/İstanbul</multiline></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:bold;
                                            text-decoration:underline;" mc:edit="tm-13"><unsubscribe>sasder.org</unsubscribe></td>
                                        </tr>
                                    </table></td>
                            </tr>
                        </table></td>
