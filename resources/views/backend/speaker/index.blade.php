...
@section('title', 'Konuşmacı Listele')
@section('content')
            ...
            <div class="card-header d-flex justify-content-between">
                <div>
                    <h4 class="card-title">
                        ...
                        Konuşmacı Listesi [{{ $All->count() }}]
                    </h4>
                </div>
                <div class="d-flex justify-content-between">
                    <a class="btn btn-primary btn-sm me-1" href="{{ route('speaker.create',['project_id' => 10]) }}" title="Konuşmacı Ekle">
                    ...
                    <a class="btn btn-primary btn-sm me-1" href="{{ route('project.index') }}" title="Kongreler">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Kongreler
                    </a>
                </div>
            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr id="page_{{$item->id}}">
                        ...
                        <td>
                            <div class="font-weight-medium">{{ $item->speaker_name }}</div>
                        </td>
                            ...
                            <div class="btn-list flex-nowrap">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item justify-content-between" href="{{ route('speaker.edit', [$item->id, 'project_id' => 10]) }}" title="Düzenle">
        ...
        $(document).ready(function() {
            $('#orders').sortable({
                update:function()
                {
                    ...
                    $.get("{{ route('speaker.getOrder') }}?"+siralama,() => {
