            ...
            <div class="col-sm-3 mt-2">
                <div class="card">
                    ...
                    <div class="card-body p-2 text-center ">
                        ...
                        <div class="text-h3 m-0 font-weight-bold">[{{ $Pages->count() }}] Kongre</div>
                        <div class="text-muted mb-3">
            ...
            <div class="col-sm-3 mt-2">
                <div class="card">
                    ...
                    <div class="card-body p-2 text-center ">
                        ...
                        <div class="text-h3 m-0 font-weight-bold">[{{ $Project}}] Etkinlik</div>
                        <div class="text-muted mb-3">
            ...
            <table class="table table-hover table-striped table-bordered table-center">
                ...
                @foreach($User as $item)
                    <tr id="slider_{{$item->id}}">
                        ...
                        <td>
                            <div class="font-weight-medium">{{ $item->tckn}}</div>
                        </td>
