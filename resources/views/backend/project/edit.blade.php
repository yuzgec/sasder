            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" data-bs-toggle="tabs">
                        <li class="nav-item">
                            <a href="#tabs-home-7" class="nav-link active" data-bs-toggle="tab">Genel</a>
                        </li>
                        <li class="nav-item">
                            <a href="#tabs-profile-7" class="nav-link" data-bs-toggle="tab">Tabs</a>
                        </li>
                                    ...
                                    <div class="divide-y">
                                        @foreach($Edit->getMedia('gallery') as $item)
                                            <tr id="gallery_{{$item->id}}">
                                                ...
                                                <td>
                                                    <form action="{{route('project.deleteGaleriDelete', $Edit->id)}}" method="POST">
