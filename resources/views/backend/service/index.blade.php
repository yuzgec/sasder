            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr id="service_{{$item->id}}">
                        ...
                        <td>
                            <div class="font-weight-medium"><a href="{{ route('service.edit', $item->id) }}" title="Düzenle">{{ $item->title }}</a></div>
                        </td>
                            ...
                            <div class="btn-list flex-nowrap">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item justify-content-between" href="{{ route('service.edit', $item->id) }}" title="Düzenle">
